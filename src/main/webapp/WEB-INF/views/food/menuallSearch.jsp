...
<style>
	...
	<script>
		function viewform(){
			...
			// food테이블의 fcode와 m1,m2,m3,m4,m5의 값을 폼에 전달
			document.aform.fcode.value = fcode;
			document.aform.m1.value = m1;
			document.aform.m2.value = m2;
			document.aform.m3.value = m3;
			document.aform.m4.value = m4;
			document.aform.m5.value = m5;
			
			/* var w = document.documentElement.clientWidth;
				var h = document.documentElement.clientHeight;
				w = w/2 - 400;
				h = h/2 + document.documentElement.scrollTop - 300;
...
<body>
	...
	<span id="tab">
		<ul id="subtab">
			<li><a href="../food/menuallSearch" id="search" onclick="viewform()">검색</a></li>
	...
	<div id="sform">
	<div id="vform">
		<form name="aform" method="post" action="menuallSearch">
