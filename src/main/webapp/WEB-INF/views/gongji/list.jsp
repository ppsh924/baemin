	...
	<table width="600" align="center" id="gongji">
		...
		<tr height="100">
			<td colspan="2" align="left">
				<a href="content?id=${ gvo.id }">
					<b style="color:black;font-size:20px;">${ gvo.title }</b>
				</a> <br> 
				<span style="color:#8C8C8C;">${ gvo.writeday }</span>
			</td>
			<td align="right">
				<img id="next" src="../resources/mybaemin/next.png" onclick="location='../gongji/content?id=${ gvo.id }'" width="50">
			</td>
		</tr>
		</c:forEach>
	</table>
	...
	<table width="600" align="center">
		...
		<tr height="50">
			<td colspan="10" align="center">
				<span id="dd"><a href="/baemin/gongji/write" style="color:black;"><b>글쓰기</b></a></span>
			</td>
		</tr>
		</c:if>
	</table>
