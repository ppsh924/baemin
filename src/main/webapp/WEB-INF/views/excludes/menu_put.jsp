	...
	$(function() {
   		$("#m1_su").spinner({
   			...
   			spin:function(e,ui){
   				...
   				var m1_price = ui.value * ${ fvo.m1_price };
   				m1_price = new Intl.NumberFormat().format(m1_price);
   				document.getElementById("pri").value = m1_price + "원 담기"; 
   			}
   		});
	});
...
<div id="aa"></div>
	<section>
		...
		<input type="hidden" name="m1" value="${ fvo.m1 }">
		...
		<table width="450"> 
			...
			<tr>
				<td colspan="2" align="center">
					<img src="../resources/food/${ fvo.m1_img }" width="300" height="200"> <p>
					
				</td>
			</tr>
			<tr height="100" id="title">
				<td colspan="2" align="center">
					<b style="font-size:18px;">${ fvo.m1 }</b> <p>
					<span style="font-size:14px;">${ fvo.m1_ex }</span>
				</td>
			</tr>
			<tr height="50">
				<td>가격</td>
			...
			<tr height="50">
				<td>수량</td>
				<td align="right" id="suform"><input type="text" name="m1_su" id="m1_su" value="1" readonly>개</td>
			</tr>
			<tr height="50">
				<td>
				...
				<td>
					<input id="pri" type="button" onclick="cartadd('${ fvo.m1 }')" value="<fmt:formatNumber value="${ fvo.m1_price }" pattern="#,###" type="number" />원 담기">
				</td>
			</tr>
