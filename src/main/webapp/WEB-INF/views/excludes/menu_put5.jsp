	...
	$(function() {
   		$("#m5_su").spinner({
   			...
   			spin:function(e,ui){
   				...
   				var m5_price = ui.value * ${ fvo.m5_price };
   				m5_price = new Intl.NumberFormat().format(m5_price);
   				document.getElementById("pri").value = m5_price + "원 담기"; 
   			}
   		});
	});
...
<div id="aa"></div>
	<section>
		...
		<input type="hidden" name="m5" value="${ fvo.m5 }">
		...
		<table width="450"> 
			...
			<tr>
				<td colspan="2" align="center">
					<img src="../resources/food/${ fvo.m5_img }" width="300" height="200"> <p>
					
				</td>
			</tr>
			<tr height="100" id="title">
				<td colspan="2" align="center">
					<b style="font-size:18px;">${ fvo.m5 }</b> <p>
					<span style="font-size:14px;">${ fvo.m5_ex }</span>
				</td>
			</tr>
			<tr height="50">
				<td>가격</td>
				<td align="right"><fmt:formatNumber value="${ fvo.m5_price }" pattern="#,###" type="number" />원</td>
			</tr>
			<tr height="50">
				<td>수량</td>
				<td align="right" id="suform"><input type="text" name="m5_su" id="m5_su" value="1" readonly>개</td>
			</tr>
			<tr height="50">
				<td>
				...
				<td>
					<input id="pri" type="button" onclick="cartadd('${ fvo.m5 }')" value="<fmt:formatNumber value="${ fvo.m5_price }" pattern="#,###" type="number" />원 담기">
				</td>
			</tr>
