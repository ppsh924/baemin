	...
	$(function() {
   		$("#m4_su").spinner({
   			...
   			spin:function(e,ui){
   				...
   				var m4_price = ui.value * ${ fvo.m4_price };
   				m4_price = new Intl.NumberFormat().format(m4_price);
   				document.getElementById("pri").value = m4_price + "원 담기"; 
   			}
   		});
	});
...
<div id="aa"></div>
	<section>
		...
		<input type="hidden" name="m4" value="${ fvo.m4 }">
		...
		<table width="450"> 
			...
			<tr>
				<td colspan="2" align="center">
					<img src="../resources/food/${ fvo.m4_img }" width="300" height="200"> <p>
					
				</td>
			</tr>
			<tr height="100" id="title">
				<td colspan="2" align="center">
					<b style="font-size:18px;">${ fvo.m4 }</b> <p>
					<span style="font-size:14px;">${ fvo.m4_ex }</span>
				</td>
			</tr>
			<tr height="50">
				<td>가격</td>
				<td align="right"><fmt:formatNumber value="${ fvo.m4_price }" pattern="#,###" type="number" />원</td>
			</tr>
			<tr height="50">
				<td>수량</td>
				<td align="right" id="suform"><input type="text" name="m4_su" id="m4_su" value="1" readonly>개</td>
			</tr>
			<tr height="50">
				<td>
				...
				<td>
					<input id="pri" type="button" onclick="cartadd('${ fvo.m4 }')" value="<fmt:formatNumber value="${ fvo.m4_price }" pattern="#,###" type="number" />원 담기">
				</td>
			</tr>
